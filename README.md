...
deterministic synthetic path and against a real historical ETH/USD series.
...
## Layout
    ...
    test/MarketBacktest.t.sol      the real-market backtest (1 test)
    scripts/fetch_prices.py        fetches the real ETH/USD series and generates test/RealPrices.sol
...
- The synthetic and real paths are price-only. Real swap-size and volume replay is the next step.
